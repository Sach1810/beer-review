var BeerReviewApp = function(){
  var reviews = [{beerName: 1, category: "Porter", rating: 3}, 
                {beerName: 2, category: "Porter", rating: 5},
                {beerName: 3, category: "Porter", rating: 1}];

    var createBeer = function(beerName, category, rating){
        var newBeer = {
          beerName: beerName,
          category: category,
          rating: rating
    ...
    var renderBeer = function(beerName, category, rating){
...
$('.post-beer').on('click', function (e) {
  ...
  beerReviewApp.create(beerName, category,rating);
  beerReviewApp.render(beerName, category,rating);



  BeerReviewApp(beerName, category, rating);
});
